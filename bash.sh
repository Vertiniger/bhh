...
while IFS= read -r proxy; do
    ...
    status_code=$(curl -s -o /dev/null -w "%{http_code}" --proxy "http://$proxy" -A "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36
" http://httpbin.org/ip)
